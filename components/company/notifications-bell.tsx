...
export function CompanyNotificationsBell({ companyId }: { companyId: Id<'profiles'> | null }) {
  ...
  return (
    <DropdownMenu open={open} onOpenChange={setOpen}>
      <DropdownMenuTrigger asChild>
        <Button variant="ghost" size="icon" className="relative" disabled={!companyId}>
      ...
      <DropdownMenuContent align="end" className="w-80 max-h-96 overflow-y-auto">
        ...
        {Array.isArray(notifications) && (notifications as any[]).map((n: any) => (
